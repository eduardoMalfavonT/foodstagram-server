const Productos = require("../Models/Productos"); //Crear el modelo para productos
const multer = require("multer");
const shortid = require("shortid");

//Configuracion del multer para subir archivos al servidor
...
//Mostrar producto mediante su id
